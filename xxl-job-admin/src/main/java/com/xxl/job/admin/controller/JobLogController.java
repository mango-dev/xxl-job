...
public class JobLogController {
	...
	public Map<String, Object> pageList(HttpServletRequest request,
										...
										@RequestParam(required = false, defaultValue = "0")int jobGroup, @RequestParam(required = false, defaultValue = "0")int jobId, int logStatus, String filterTime,String author) {
